  ...
  return (
    <BrowserRouter>
      <div className="bg-customBg font-mono">
        {/* {window.location.path = "/admin/*" ? "" : <Header/>} */}
   ...
   <Route path="api/admin/account" element={<AccountPage/>} />
   {/* <Route
              path="/admin/account"
              element={
                isAuthenticated ? (
            ...
            <Route path="/api/admin/game" element={<GamePage/>} />
       


<Route path="/api/gamesystem" element={<GameSystemRequirementPage/>} />
         



  <Route path="/api/gametypes" element={<GameTypePage/>} />



  <Route path="/api/keycodes" element={<KeyCodePage/>} />
  ...
  <Route path="/api/chart" element={<Chart/>} />
...
<Route path="/contact" element={<ContactPage/>} />
        ...
        {/* {window.location.path = "/admin/*" ? "" : <Footer/>} */}
      </div>
    </BrowserRouter>
  );
}
